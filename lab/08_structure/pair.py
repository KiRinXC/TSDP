...
def main() -> int:
    ...
    for case in CASES:
        ...
        del surrogate
    if args.dry_run:
        print("[INFO] dry-run 完成，未写入 Lab08 结构配对产物。")
        return 0
    ...
    data_path = out_dir / "pair.tsv"
    history_path = out_dir / "pair_history.tsv"
    plot_path = out_dir / "pair.png"
